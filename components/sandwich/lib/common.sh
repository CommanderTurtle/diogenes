...
readonly SANDWICH_BIN="${SANDWICH_BUN:-${BUN_SOVEREIGN_BUN:-${BUN_INSTALL:-$HOME/.bun}/bin/bun}}"
readonly SANDWICH_NPM_VERSION="${SANDWICH_NPM_VERSION:-${BUN_SOVEREIGN_NPM_VERSION:-10.9.8}}"
readonly SANDWICH_PNPM_VERSION="${SANDWICH_PNPM_VERSION:-${BUN_SOVEREIGN_PNPM_VERSION:-10.0.0}}"
readonly SANDWICH_YARN_VERSION="${SANDWICH_YARN_VERSION:-${BUN_SOVEREIGN_YARN_VERSION:-1.22.22}}"

# Compatibility aliases for the original Bun Sovereign scripts and callers.
readonly BUN_SOVEREIGN_ROOT="$SANDWICH_ROOT"
readonly BUN_SOVEREIGN_BIN="$SANDWICH_BIN"
readonly BUN_SOVEREIGN_NPM_VERSION="$SANDWICH_NPM_VERSION"
readonly BUN_SOVEREIGN_PNPM_VERSION="$SANDWICH_PNPM_VERSION"
readonly BUN_SOVEREIGN_YARN_VERSION="$SANDWICH_YARN_VERSION"
