...
6. Set Google Oauth Credentials to the full path of the downloaded JSON file` },
  ...
  { name: "Browser (Camofox)", command: "npx", args: ["-y", "camofox-mcp@latest"], env: { CAMOFOX_URL: "http://127.0.0.1:9377" },
    help: "Connect Ɗiogenēs to a separately running Camofox browser service. Install and manage the browser backend in Services, then keep CAMOFOX_URL pointed at that local endpoint. On a Sandwich host, npx resolves through Bun without installing Node." },
  { name: "Browser (Playwright)", command: "npx", args: ["-y", "@playwright/mcp@latest", "--headless"],  env: {},
    help: "Explicit alternative browser automation through Playwright MCP. It is never selected automatically by Ɗiogenēs. This package may install its own Chromium browser." },
