...
install with `uv pip install --python .venv/bin/python -r requirements-optional.txt`. When absent, callers
...
MARKITDOWN_MISSING = (
    ...
    "dependencies with `uv pip install --python .venv/bin/python -r requirements-optional.txt`."
)
